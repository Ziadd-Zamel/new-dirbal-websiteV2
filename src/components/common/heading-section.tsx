          ...
          <div dir="rtl" className="text-right">
            <div className="mt-10 sm:mt-20 lg:mt-24">
              <div className="flex flex-col justify-between sm:flex-row sm:items-center xl:w-[90%]">
                <motion.h2
                  className="text-justify font-tajawal text-2xl font-semibold text-white sm:text-4xl min-[1900px]:text-5xl!"
                    ...
                    <ol className="flex items-center space-x-1 space-x-reverse rtl:space-x-reverse">
                      ...
                      {breadcrumbs.map((item, index) => (
                        <React.Fragment key={index}>
                          <li className="mx-1 text-[18px] min-[1900px]:text-xl!">
                            <span className="text-[18px] min-[1900px]:text-xl! text-[#B4935C]">
                              <ChevronLeft size={20} />
                            </span>
                          </li>
                          <li>
              ...
              <motion.p
                className={`scrollbar-hide mt-6 max-h-[400px] overflow-y-auto text-justify font-tajawal font-[400] text-gray-300 md:text-[21px] min-[1900px]:text-2xl! lg:h-full lg:max-h-none xl:w-[90%] xl:leading-[30px] min-[1900px]:leading-[50px]! ${textcolor}`}
