...
const CommentForm = () => {
  ...
  return (
    <div
      style={{ direction: "rtl" }}
      className="mb-10 mt-32 w-full rounded-lg text-right text-white"
    >
      <h2 className="flex items-center gap-2 text-md font-semibold">
        <FaRegComment className="text-[#D9A760]" /> أضف تعليقاً
      </h2>
      <textarea
        className="mt-4 h-44 w-full rounded-md bg-[#F2F2F2] p-3 text-black placeholder:font-tajawal focus:outline-none"
        placeholder="نص التعليق"
      ></textarea>
      <div className="mt-4 flex gap-4">
        <input
          type="email"
          className="w-1/2 rounded-md bg-[#F2F2F2] p-2 text-black placeholder:font-tajawal focus:outline-none"
